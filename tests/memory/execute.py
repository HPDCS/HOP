...
FREQUENCIES = ['1024', '2048', '4096', '8192']
...
def main() :
	...
	for ctn in ISTR_CTN :
		...
		for freq in FREQUENCIES :	
			...
			writeList('hop' + freq, fineList)
			writeInfo('hop' + freq, time)

		writeAgg('agg', agg)

		cmd(['touch', DIR_RESULT + '/' + DIR_INFO + '/' + ctn + '.inf'])
